...
function loadWeather(location, woeid) {
    $.simpleWeather({
        ...
        success: function(weather) {
            ...
            html2 = '<div class="location"><span class="city">' + weather.city + '</span><span class="state">' + weather.region + '</span>';
            //Current weather
            html2 += '<div id="weathercode">' + weather.code + '</div> <div id ="temp">' + weather.temp + '&deg;</div></div>';
            //lows
            html2 += '<div class="row">';
            for (var i = 0; i < 3; i++) {
            ...
            if (moment(currTime).isBefore(sunset)) {
